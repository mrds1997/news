...
class GetTopHeadlineNewsBySourceUseCase extends UseCase<DataState<NewsEntity>, NewsParam>{

  NewsRepository repository;

  GetTopHeadlineNewsBySourceUseCase(this.repository);

  @override
  Future<DataState<NewsEntity>> call(NewsParam param) async {
    return await repository.getTopHeadlineNewsBySource(param);
  }
