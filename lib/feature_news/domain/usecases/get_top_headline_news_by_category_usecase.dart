...
class GetTopHeadlineNewsByCategoryUseCase extends UseCase<DataState<NewsEntity>, NewsParam>{

  NewsRepository repository;

  GetTopHeadlineNewsByCategoryUseCase(this.repository);

  @override
  Future<DataState<NewsEntity>> call(NewsParam param) async {
    return await repository.getTopHeadlineNewsByCategory(param);
  }
